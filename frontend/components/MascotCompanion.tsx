...
// compete with reading/studying; grows and speaks only when celebrate()
// is called from wherever the moment actually happens (finishing a quiz,
// starting a topic, etc).
export default function MascotCompanion() {
  ...
  return (
    <div className="pointer-events-none fixed bottom-4 right-4 z-40 flex flex-col items-end gap-2">
      ...
      <div
        className={`transition-transform duration-300 ${speaking ? "scale-110" : "scale-100 opacity-80"}`}
      >
